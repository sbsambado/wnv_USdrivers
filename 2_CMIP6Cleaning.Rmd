...
##Purpose
Process CMIP6 data and format into a shape that works well for R0(T) models. I am working with data for three time periods under two emission scenarios. Time periods are historic/current (2015-2020), mid-century (2045-2074), and late-century (2075-2100). Emission scenarios are SSP2-4.5 (low-emissions) and SSP5-8.5.
...
process_temp_raster <- function(nc_file, counties_sf, temp_type = c("max", "min"), rcp, century) {
  ...
  # extract mean values for each polygon & each raster layer
...
max_245_hist <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmax.GFDL-CM4.ssp585.r1i1p1f1.2015-2044.LOCA_16thdeg_v20220413.monthly.nc",
...
min_245_hist <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmin.GFDL-CM4.ssp245.r1i1p1f1.2015-2044.LOCA_16thdeg_v20220413.monthly.nc",
  counties_sf = counties_sf,
  temp_type = "min",
  rcp = 245,
  century = "historic")

# join min & max dataframes by GEOID, date, rcp, century
...
max_245_mid <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmax.GFDL-CM4.ssp245.r1i1p1f1.2045-2074.LOCA_16thdeg_v20220413.monthly.nc",
  counties_sf = counties_sf,
  temp_type = "max",
  rcp = 245,
  century = "mid")
...
# process min temp for same scenario
min_245_mid <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmin.GFDL-CM4.ssp245.r1i1p1f1.2045-2074.LOCA_16thdeg_v20220413.monthly.nc",
  counties_sf = counties_sf,
  temp_type = "min",
  rcp = 245,
  century = "mid")
...
max_585_hist <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmax.GFDL-CM4.ssp585.r1i1p1f1.2015-2044.LOCA_16thdeg_v20220413.monthly.nc",
  counties_sf = counties_sf,
  temp_type = "max",
  rcp = 585,
  century = "historic")
...
# process min temp for same scenario
min_585_hist <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmin.GFDL-CM4.ssp585.r1i1p1f1.2015-2044.LOCA_16thdeg_v20220413.monthly.nc",
  counties_sf = counties_sf,
  temp_type = "min",
  rcp = 585,
  century = "historic")
...
max_585_mid <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmax.GFDL-CM4.ssp585.r1i1p1f1.2045-2074.LOCA_16thdeg_v20220413.monthly.nc",
  counties_sf = counties_sf,
  temp_type = "max",
  rcp = 585,
  century = "mid")
...
# Process min temp for same scenario
min_585_mid <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmin.GFDL-CM4.ssp585.r1i1p1f1.2045-2074.LOCA_16thdeg_v20220413.monthly.nc",
  counties_sf = counties_sf,
  temp_type = "min",
  rcp = 585,
  century = "mid")
...
max_585_late <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmax.GFDL-CM4.ssp585.r1i1p1f1.2075-2100.LOCA_16thdeg_v20220413.monthly.nc",
  counties_sf = counties_sf,
  temp_type = "max",
  rcp = 585,
  century = "late")
...
# process min temp for same scenario
min_585_late <- process_temp_raster(nc_file = "data/raw/cmip6/gfdl_cm4/tasmin.GFDL-CM4.ssp585.r1i1p1f1.2075-2100.LOCA_16thdeg_v20220413.monthly.nc",
  counties_sf = counties_sf,
  temp_type = "min",
  rcp = 585,
  century = "late")
